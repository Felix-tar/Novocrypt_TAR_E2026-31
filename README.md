...
Die Bedienung erfolgt über drei einzelne Softwarekomponenten: eine für den Prüfer am PC unter Windows, die Messsoftware auf dem Messgerät (bzw. dem Raspberry Pi 5) und die Clientsoftware, mit der der Kunde die Messdaten und die Protokollierung einsehen kann. Das Ganze funktioniert wie folgt:  Zunächst muss der Kunde einen Account in der Clientsoftware erstellen. Danach gibt er dem Prüfer seinen öffentlichen Schlüssel. Der Prüfer nutzt die Hauptsoftware „Novocrypt“, um die Maschine anzulegen und die Messstruktur zu erstellen. Anschließend lädt er die Struktur und die Maschineninformationen auf sein Messgerät und beginnt mit der Messung. Die Messwerte werden direkt in die Solana-Blockchain hochgeladen.  Sind alle Messungen abgeschlossen, geht der Prüfer zurück an seinen PC und beendet die Messung, indem er alle Daten verschlüsselt auf ArDrive hochlädt. Mit der ArDrive-TXID bzw. einem Arweave-Link kann der Kunde in der Novocrypt-Clientsoftware die Daten dann von der Blockchain laden.  Dieses Verfahren soll den Gebrauch von PDF oder Papier komplett ersetzen. Somit müssen keine Daten auf Servern gespeichert werden, da sie jederzeit live von der manipulationssicheren Blockchain abgerufen werden können.

---

## Status, Updates und Ausblick
...
![schilder_zeichnung](gifs/tar_schilder_2.png)
...
- Umsetzung kleinerer Änderungen an Hard- und Software



### Update – 01.12.2025
- Zusammenführung der beiden Platinen in einer **Doppeldecker-Konfiguration**  
- Kürzen und Neuverlegen der Leitungen  
- Durchführung eines ersten Testdrucks des Gehäuses

![3dmodell](gifs/3d_gehäusev1.png)



### Update – 29.11.2025
- Reparatur der zuvor entstandenen Schäden und erneuter Aufbau des Geräts  
- Erweiterung der Stromversorgung um eine Ansteuerung mittels **Transistor und Relais**  
- Entscheidung zum **Entfall der zusätzlichen Batterie für die Messkarte**  
- Die Stromversorgung wird nun direkt an den **Waveshare UPS Batteriecontroller** angeschlossen und über Steckverbinder modular aufgebaut  
- Auslöten des integrierten Einschaltters am Batteriecontroller, um das System über einen externen Gehäuseschalter bedienen zu können  

![stromquellev2](gifs/stromquellev2.png)



### Update – 08.11.2025
**Rückschlag:**  
Durch eine Unachtsamkeit bei der Anordnung der Komponenten während der Vermessung für die 3D-Modellierung entstand ein Kurzschluss.  

Dabei wurden folgende Komponenten beschädigt:
- Raspberry Pi  
- Waveshare UPS Batteriecontroller  
- ADS1115 Analog-Digital-Wandler  
- Ladegerät  

Neue Bauteile wurden bestellt.  
Der entstandene Schaden beträgt ca. **160 €** und führte zu einer **Verzögerung im Terminplan**.



### Update – 13.10.2025
- Weiteres Debugging der Kommunikation zwischen Hardware und Software  
- Beginn der **3D-Modellierung des Gehäuses**



### Update – 26.09.2025
- Erste Tests mit beiden Platinen  
- Crimpen der Verbindungsleitungen  
- Verdrahtung des Touchscreens  
- Integration der Software und Verbindung aller Komponenten zum ersten vollständigen Testaufbau  

![prüfaufbauv1](gifs/ganzer_prüfaufbau_v1.JPG)



### Update – 25.09.2025
- Aufbau einer **Prototyp-Messkarte**, um Übergangswiderstände und mögliche Fehlerquellen zu minimieren  
- Bestückung der Messkarte mit:
  - Spannungsteiler  
  - Shunt-Widerstand  
  - ADS1115 Analog-Digital-Wandler  

![messkarte](gifs/messkartev1.JPG)



### Update – 25.09.2025
- Aufbau einer modularen **Konstantstromquelle** zu Testzwecken  
- Erste Version ohne Steuerung.

![Stromquelle](gifs/konstantstromquellev1.png)



### Update – 02.09.2025 (Beginn der Hardwarekonstruktion)
- Berechnung des erforderlichen Widerstands am **Vout–ADJ Kontakt (6,2 Ω)** mit einer Mindestleistung von **0,5 W**  
- Aufbau einer Konstantstromquelle mit **7,2 V Versorgungsspannung** und einem Ausgangsstrom von mindestens **200 mA**  
- Bestimmung der benötigten **2 mV Shuntspannung** mittels Multimeter  
- Anschließende Integration des **ADS1115**, um die analogen Messwerte digital auszulesen und auf dem Raspberry Pi darzustellen
...
### Update – 10.08.2025 (Beginn Software)
